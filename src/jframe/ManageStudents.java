...
//    This method is used to add student to student_details
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 680, 450));
        ...
        jPanel2.add(rSButtonHover7, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 590, 110, -1));
    ...
    private void txt_StudentNameActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
    }                                               
    ...
    private void rSButtonHover2ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
        if (addStudent()) {
    ...
    private void rSButtonHover3ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
        if (deleteStudent()) {
    ...
    private void kButton6MouseClicked(java.awt.event.MouseEvent evt) {                                      
        // TODO add your handling code here:
        System.exit(0);
    }                                     
    ...
    private void kButton6KeyPressed(java.awt.event.KeyEvent evt) {                                    
        // TODO add your handling code here:
    }                                   

    private void kButton8MouseClicked(java.awt.event.MouseEvent evt) {                                      
        // TODO add your handling code here:
    ...
    private void kButton8KeyPressed(java.awt.event.KeyEvent evt) {                                    
        // TODO add your handling code here:
    }                                   

    private void tbl_student_detailsMouseClicked(java.awt.event.MouseEvent evt) {                                                 
        // TODO add your handling code here:
...
//        column will start usually 0
    ...
    private void txt_phoneNoActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
    }                                           

    private void rSButtonHover7ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
        String path = "";
        ...
        if (path != "") {
            ...
            try {
                ...
                Paragraph docTitle = new Paragraph("Students", f);
                ...
                tbl.addCell(new Paragraph("Name", f1));
                tbl.addCell(new Paragraph("Phone no", f1));
                tbl.addCell(new Paragraph("Session", f1));
                tbl.addCell(new Paragraph("Department", f1));
                tbl.addCell(new Paragraph("Degree", f1));
                for (int i = 0; i < tbl_student_details.getRowCount(); i++) {
                    String studentId1 = tbl_student_details.getValueAt(i, 0).toString();
                    String studentName1 = tbl_student_details.getValueAt(i, 1).toString();
                    String studentPhoneNo1 = tbl_student_details.getValueAt(i, 2).toString();
                    String session1 = tbl_student_details.getValueAt(i, 3).toString();
                    String department1 = tbl_student_details.getValueAt(i, 4).toString();
                    String degree1 = tbl_student_details.getValueAt(i, 5).toString();

                    tbl.addCell(studentId1);
                    tbl.addCell(studentName1);
                    tbl.addCell(studentPhoneNo1);
                    tbl.addCell(session1);
                    tbl.addCell(department1);
                    tbl.addCell(degree1);
