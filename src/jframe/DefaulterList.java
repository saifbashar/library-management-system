...
//        Date uFromDate = mDate_issueDate.getDate();
        Date uToDate = mDate_dueDate.getDate();
...
//        java.sql.Date fromDate = new java.sql.Date(l1);
        ...
        try {
            Connection con = DBConnection.getConnection();
//            String sql = "SELECT * FROM `issue_book_details` WHERE due_date BETWEEN ? and ? and status = \"Pending\"; ";
//            PreparedStatement pst = con.prepareStatement(sql);
...
//            pst.setDate(2, fromDate);
    ...
    public void searchByStudentId() {
        ...
        try {
            Connection con = DBConnection.getConnection();
            String sql = "select * from issue_book_details where due_date < ? and student_id = ? and status = ?;";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setDate(1, todaysDate);
            pst.setInt(2, studentId1);
    ...
    public void searchByBookId() {
        ...
        try {
            Connection con = DBConnection.getConnection();
            String sql = "select * from issue_book_details where due_date < ? and book_id = ? and status = ?;";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setDate(1, todaysDate);
            pst.setInt(2, bookId1);
            pst.setString(3, "Pending");
            ResultSet rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Defaulter Details");
        ...
        jPanel1.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 50, 40));
        ...
        jPanel1.add(rSButtonHover3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, 100, -1));
        ...
        jPanel1.add(rSButtonHover4, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 140, 220, 40));
        ...
        jPanel1.add(rSButtonHover5, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 110, 100, -1));

        jLabel24.setBackground(new java.awt.Color(0, 0, 0));
        jLabel24.setFont(new java.awt.Font("SF UI  Text", 0, 18)); // NOI18N
        jLabel24.setText("Book Id:");
        jPanel1.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 170, 80, 40));
        ...
        jPanel1.add(txt_bookId, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 170, 220, 40));
        ...
        jPanel1.add(rSButtonHover6, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 170, 100, -1));

        jLabel22.setBackground(new java.awt.Color(0, 0, 0));
        jLabel22.setFont(new java.awt.Font("SF UI  Text", 0, 18)); // NOI18N
        jLabel22.setText("Student Id:");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 110, 100, 40));
        ...
        jPanel1.add(txt_studentId, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 110, 220, 40));
        jPanel1.add(mDate_dueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 150, 220, 40));
        ...
        panel_table.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 1130, 250));
        ...
        panel_table.add(rSButtonHover7, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 330, 110, -1));
...
//        date_fromDate.getDatoFecha() != null && date_toDate.getDatoFecha() != null
        if ( mDate_dueDate.getDate() != null) {
...
//        mDate_issueDate.setDate(null);
        mDate_dueDate.setDate(null);
        txt_studentId.setText("");
        txt_bookId.setText("");
...
//            mDate_issueDate.setDate(null);
    ...
    private void rSButtonHover7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover7ActionPerformed
        ...
        if (path != "") {
            ...
            try {
                PdfWriter.getInstance(doc, new FileOutputStream(path + "Defaulter List.pdf"));
                doc.open();
                ...
                Paragraph docTitle = new Paragraph("Defaulter List", f);
...
//            
                ...
                for (int i = 0; i < tbl_issueBookDetails.getRowCount(); i++) {
                    ...
                    tbl.addCell(new Paragraph(dueDate, f2));
                    tbl.addCell(status);
