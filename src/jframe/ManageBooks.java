...
//    This method is used to add Book
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 650, 460));
    ...
    private void tbl_book_detailsMouseClicked(java.awt.event.MouseEvent evt) {                                              
        // TODO add your handling code here:
...
//        column will start usually 0
    ...
    private void txt_categoryFocusLost(java.awt.event.FocusEvent evt) {                                       
        // TODO add your handling code here:
    }                                      

    private void txt_categoryActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            
    ...
    private void rSButtonHover7ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        ...
        if (path != "") {
            ...
            try {
                PdfWriter.getInstance(doc, new FileOutputStream(path + "all books.pdf"));
                doc.open();
                ...
                Paragraph docTitle = new Paragraph("Books", f);
                ...
                tbl.addCell(new Paragraph("Author", f1));
                tbl.addCell(new Paragraph("Category", f1));
                tbl.addCell(new Paragraph("Quantity", f1));

                for (int i = 0; i < tbl_book_details.getRowCount(); i++) {
                    String bookId = tbl_book_details.getValueAt(i, 0).toString();
                    String bookName = tbl_book_details.getValueAt(i, 1).toString();
                    String author1 = tbl_book_details.getValueAt(i, 2).toString();
                    String category1 = tbl_book_details.getValueAt(i, 3).toString();
                    String quantity1 = tbl_book_details.getValueAt(i, 4).toString();

                    tbl.addCell(bookId);
                    tbl.addCell(bookName);
                    tbl.addCell(author1);
                    tbl.addCell(category1);
                    tbl.addCell(quantity1);
